...
import '/components/novo_curso_widget.dart';
              ...
              children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            fit: BoxFit.cover,
                            image: Image.asset(
                              'assets/images/curso-appgyver-gratuito_(2).jpg',
                            ).image,
                          ),
                        ),
                      ),
                ...
                FutureBuilder<List<CursosRow>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<CursosRow> listViewCursosRowList = snapshot.data!;
                    return ListView.builder(
                      padding: EdgeInsets.zero,
                      shrinkWrap: true,
                      scrollDirection: Axis.vertical,
                      itemCount: listViewCursosRowList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewCursosRow =
                            listViewCursosRowList[listViewIndex];
                        return Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              16.0, 8.0, 16.0, 8.0),
                          child: InkWell(
